...
concept_map = {
    ...
    "care_facility_enrolled": {"concept_id": 1000765, "type": "text"},
    "reason_not_in_hiv_care_id": {"concept_id": 1000784, "type": "coded"},
    "reason_not_in_hiv_care_other": {"concept_id": 1000785, "type": "text"},
    "reasonnottestedforhiv_id": {"concept_id": 1000784, "type": "coded"},
    "reason_never_tested_for_hiv_other": {"concept_id": 1000785, "type": "text"},
    "knowledge_of_hiv_test_centres_id": {"concept_id": 1000786, "type": "coded"},
}
...
def main():
    ...
    df = pd.read_csv("csvs/sexual_activity.csv")
